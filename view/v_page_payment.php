        ...
        <div class="col-sm-8 mb-3 mb-sm-0">
            <form class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="validationCustom03" placeholder="Ví dụ Hẻm 45, Lê Quý Đôn" required>
                    <div class="invalid-feedback">
                    </div>
                </div>
                <div class="col-12">
                    <label for="exampleFormControlTextarea1" class="form-label"><strong>Thông tin bổ
                            sung</strong></label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Ghi chú về đơn hàng chi tiết hơn"></textarea>
                </div>
                ...
                <div class="col-12">
                    <a href="<?= $base_url ?>/page/thanks" class="btn btn-warning" type="submit" style="padding: 10px 80px; font-size: 18px; font-weight: 600; margin-left: 72%; color: #ffffff;">Đặt Hàng</a>
                </div>
            </form>
