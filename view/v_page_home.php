                ...
                <div class="container ">
                    <div class="row">
                        <div class="col" style="height: 440px;">
                            <div class="card" style="width: 18rem;">
                                <img src="<?=$base_url?>/template/assets_user/image/sp1.webp" class="card-img-top" alt="..." style="height: 250;">
                                <div class="badge badge-danger bg-danger position-absolute"
                                    style="top: 20px; right: 20px;">
                                    Sale 7%</div>
                                <div class="card-body">
                                    <h5 class="card-title">Phốc Mini Trắng</h5>
                                    <p class="card-text">Hình dạng: Mini</p>
                                    <p class="card-price">Giá: <del>14.500.000đ</del> 13.200.000 </p>
                        ...
                        <div class="col" style="height: 440px;">
                            <div class="card" style="width: 18rem;">
                                <img src="<?=$base_url?>/template/assets_user/image/sp2.webp" class="card-img-top" alt="...">
                                <div class="badge badge-danger bg-danger position-absolute d-none"
                                    style="top: 20px; right: 20px;">
                                    Sale 7%</div>
                                <div class="card-body">
                                    <h5 class="card-title">Mèo Anh lông ngắn</h5>
                                    <p class="card-text">Hình dạng: Lớn</p>
                                    <p class="card-price">Giá: 18.200.000 </p>
                                    <div class="btn-buy d-flex text-center">
                                        <a href="#" class="btn btn-warning" style=" margin-left: 15px;">Chi
                                            Tiết</a>
                                        <a href="#" class="btn btn-warning" style=" margin-left: 50px;">Mua
                        ...
                        <div class="col" style="height: 440px;">
                            <div class="card" style="width: 18rem;">
                                <img src="<?=$base_url?>/template/assets_user/image/sp3.webp" class="card-img-top" alt="...">
                                <div class="badge badge-danger bg-danger position-absolute"
                                    style="top: 20px; right: 20px;">
                                    Sale 23%</div>
                                <div class="card-body">
                                    <h5 class="card-title">Chó Alaska trắng</h5>
                                    <p class="card-text">Hình dạng: Lớn</p>
                                    <p class="card-price">Giá: <del>18.500.000đ</del> 15.200.000 </p>
                                    <div class="btn-buy d-flex text-center">
                                        <a href="#" class="btn btn-warning" style=" margin-left: 15px;">Chi
                                            Tiết</a>
                                        <a href="#" class="btn btn-warning" style=" margin-left: 50px;">Mua
                        ...
                        <div class="col" style="height: 440px;">
                            <div class="card" style="width: 18rem;">
                                <img src="<?=$base_url?>/template/assets_user/image/sp4.webp" class="card-img-top" alt="...">
                                <div class="badge badge-danger bg-danger position-absolute"
                                    style="top: 20px; right: 20px;">
                                    Sale 7%</div>
                                <div class="card-body">
                                    <h5 class="card-title">Chó Bull Pháp</h5>
                                    <p class="card-text">Hình dạng: Mini</p>
                                    <p class="card-price">Giá: <del>15.500.000đ</del> 14.200.000 </p>
                                    <div class="btn-buy d-flex text-center">
                                        <a href="#" class="btn btn-warning" style=" margin-left: 15px;">Chi
                                            Tiết</a>
                                        <a href="#" class="btn btn-warning" style=" margin-left: 50px;">Mua
                    ...
                    <div class="title-bosat">
                        <div class="title text-center mt-5 mt-5">
                            <h2 style="font-weight: bolder; color: #fcb000;"> _ Thú Cưng Lạ _</h2>
                        </div>
                        <div class="row mt-5">
                            <div class="col" style="height: 440px;">
                                <div class="card" style="width: 18rem;">
                                    <img src="<?=$base_url?>/template/assets_user/image/la1.webp" class="card-img-top" alt="...">
                                    <div class="badge badge-danger bg-danger position-absolute"
                                        style="top: 20px; right: 20px;">Sale 7%</div>
                                    <div class="card-body">
                                        <h5 class="card-title">Nhím kiểng gai cam</h5>
                                        <p class="card-text">Hình dạng: Mini</p>
                                        <p class="card-price">Giá: <del>8.500.000đ</del> 7.200.000 </p>
                                        <div class="btn-buy d-flex text-center">
                            ...
                            <div class="col" style="height: 440px;">
                                <div class="card" style="width: 18rem;">
                                    <img src="<?=$base_url?>/template/assets_user/image/la2.webp" class="card-img-top" alt="...">
                                    <div class="badge badge-danger bg-danger position-absolute"
                                        style="top: 20px; right: 20px;">Sale 7%</div>
                                    <div class="card-body">
                                        <h5 class="card-title">Bọ lông xoáy</h5>
                                        <p class="card-text">Hình dạng: Mini</p>
                                        <p class="card-price">Giá: <del>6.500.000đ</del> 4.200.000 </p>
                                        <div class="btn-buy d-flex text-center">
                                            <a href="#" class="btn btn-warning" style=" margin-left: 15px;">Chi Tiết</a>
                                            <a href="#" class="btn btn-warning" style=" margin-left: 50px;">Mua Ngay</a>
                                        </div>
                            ...
                            <div class="col" style="height: 440px;">
                                <div class="card" style="width: 18rem;">
                                    <img src="<?=$base_url?>/template/assets_user/image/la3.webp" class="card-img-top" alt="...">
                                    <div class="badge badge-danger bg-danger position-absolute"
                                        style="top: 20px; right: 20px;">Sale 7%</div>
                                    <div class="card-body">
                                        <h5 class="card-title">Chim vẹt yến phụng</h5>
                                        <p class="card-text">Hình dạng: lớn</p>
                                        <p class="card-price">Giá: <del>8.500.000đ</del> 7.200.000 </p>
                                        <div class="btn-buy d-flex text-center">
                                            <a href="#" class="btn btn-warning" style=" margin-left: 15px;">Chi Tiết</a>
                            ...
                            <div class="col" style="height: 440px;">
                                <div class="card" style="width: 18rem;">
                                    <img src="<?=$base_url?>/template/assets_user/image/la5.webp" class="card-img-top" alt="..." width="250px">
                                    <div class="badge badge-danger bg-danger position-absolute"
                                        style="top: 20px; right: 20px;">Sale 7%</div>
                                    <div class="card-body">
                                        <h5 class="card-title">Thỏ sư tử(lông xù)</h5>
                                        <p class="card-text">Hình dạng: lớn</p>
                                        <p class="card-price">Giá: <del>4.500.000đ</del> 3.200.000 </p>
                                        <div class="btn-buy d-flex text-center">
                                            <a href="#" class="btn btn-warning" style=" margin-left: 15px;">Chi Tiết</a>
                                            <a href="#" class="btn btn-warning" style=" margin-left: 50px;">Mua Ngay</a>
                                        </div>
        ...
        <section>
            ...
            <div class="container text-center">
                ...
                <div class="row mt-5">
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dv1.jpg" class="card-img-top" alt="..."
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dv2.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="badge badge-danger bg-danger position-absolute d-none"
                                style="top: 20px; right: 20px;">
                                Sale 7%</div>
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dv3.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="badge badge-danger bg-danger position-absolute" style="top: 20px; right: 20px;">
                                Sale 7%</div>
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dv4.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="badge badge-danger bg-danger position-absolute d-none"
                                style="top: 20px; right: 20px;">
                                Sale 7%</div>
        ...
        <section>
            <div class="container text-center">
                ...
                <div class="row mt-5">
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/thucan1.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/thucan2.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/thucan3.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/thucan4.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dungcu1.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dc2.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dc3.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
                    ...
                    <div class="col" style="height: 440px;">
                        <div class="card" style="width: 18rem;">
                            <img src="<?=$base_url?>/template/assets_user/image/dc4.jpg" class="card-img-top" alt="..."
                                style="height: 250px; object-fit: cover;">
                            <div class="card-body">
            ...
            <div class="container text-center" style="background-color: #ebf0f8; ">
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <p class="p-3 pt-2"
                            style="border-radius: 5px;width: 640px;background-color: #e2f2f2;box-shadow: 0.5px 0.5px gray;">
                    ...
                    <div class="col-md-6">
                        <div class="hd-right">
                            <div class="hd d-flex mb-3"
                                style="border-radius: 5px; background-color: #e2f2f2; box-shadow: 2px 0.5px gray;">
                                <img src="<?=$base_url?>/template/assets_user/image/hd2.jpg" alt="" style="width: 150px;border-radius: 5px; ">
                                <span class="text-center w-100 pt-4" style="font-size: 21px;"><a href="#"
                                        style="text-decoration:none; color:#212529;">Hướng dẫn nuôi mèo cưng cho người
                                        mới</a></span>
                            </div>
                            <div class="hd d-flex mb-3"
                                style="border-radius: 5px; background-color: #e2f2f2; box-shadow: 2px 0.5px gray;">
                                ...
                                <span class="text-center w-100 pt-4" style="font-size: 21px;"><a href="#"
                                        style="text-decoration:none; color:#212529;">Chăm sóc chó Poodle từ A đến
                                        Z</a></span>
                            </div>
                            <div class="hd d-flex mb-3"
                                style="border-radius: 5px; background-color: #e2f2f2; box-shadow: 2px 0.5px gray;">
                                ...
                                <span class="text-center w-100 pt-4" style="font-size: 21px;"><a href="#"
                                        style="text-decoration:none; color:#212529;">Cách nuôi, chăm sóc chó
                                        Alaska</a></span>
                            </div>
                            <div class="hd d-flex mb-3"
                                style="border-radius: 5px; background-color: #e2f2f2; box-shadow: 2px 0.5px gray;">
                                ...
                                <span class="text-center w-100 pt-4" style="font-size: 21px;"><a href="#"
                                        style="text-decoration:none; color:#212529;">Kỹ thuật nuôi chó Corgi</a></span>
                            </div>
                        </div>
                    </div>
                ...
                <div id="carouselExample" class="carousel slide">
                    <div class="carousel-inner " style="height: 300px;">
                        <div class="carousel-item active text-center p-3" style="background-color: #ebf0f8;">
                            <div class="col ">
                                <img src="<?=$base_url?>/template/assets_user/image/goku.jpg" alt=""
                ...
                <div class="container ">
                    <div class="row">
                        <div class="col m-2" style=" width: 310px; ">
                            <img src="<?=$base_url?>/template/assets_user/image/tt5.webp" alt=""
                                style="width: 400px; height: 250px; margin-right: 20px; object-fit: cover;">
                        ...
                        <div class="text-center mt-3">
                            <button type="button" class="btn btn-warning text-center"><a href="#"
                                    style="color: #212529; text-decoration: none;">Xem Thêm</a></button>
